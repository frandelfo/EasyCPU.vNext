...
namespace EasyCPU.vNext.Views
{
    ...
    public partial class MainView : UserControl
    {
        ...
        public MainView()
        {
            ...
            _mainEditorView = this.FindControl<MainEditorView>("MainEditorViewControl")
                               ?? throw new InvalidOperationException("MainEditorView not found.");

            _textEditor = _mainEditorView.FindControl<TextEditor>("Editor");
            ...
            _addControlButton = _mainEditorView.FindControl<Button>("addControlBtn");
            _addControlButton.Click += AddControlButton_Click;

            _clearControlButton = _mainEditorView.FindControl<Button>("clearControlBtn");
            _clearControlButton.Click += ClearControlButton_Click;

            _insertSnippetButton = _mainEditorView.FindControl<Button>("insertSnippetBtn");
            ...
            _syntaxModeCombo = _mainEditorView.FindControl<ComboBox>("syntaxModeCombo");
            ...
            _statusTextBlock = _mainEditorView.FindControl<TextBlock>("StatusText");
